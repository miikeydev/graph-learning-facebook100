...
L'objectif de cette étude est d'explorer les mécanismes de formation des liens sociaux au sein de ces communautés universitaires. Notre méthodologie combine deux niveaux d'analyse complémentaires. D'une part, nous conduisons une analyse statistique systématique sur l'intégralité des 100 réseaux pour caractériser les propriétés topologiques (densité, clustering) et étudier les phénomènes d'homophilie et d'assortativité. D'autre part, nous restreignons l'analyse des distributions et l'évaluation algorithmique (prédiction de liens, détection de communautés) à un échantillon de 15 réseaux représentatifs, couvrant un spectre large de tailles et de densités. Enfin, nous approfondissons certains cas contrastés pour mettre en évidence l'influence de la topologie locale sur les performances des algorithmes.
...
L'analyse comparée de réseaux de tailles différentes met en évidence un phénomène d'échelle. Le Tableau~\ref{tab:metrics} synthétise les métriques topologiques fondamentales pour trois campus représentatifs.
...
\begin{subfigure}[b]{0.32\textwidth}
    ...
    \caption{MIT8}
\end{subfigure}
\caption{Distribution des degrés en échelle semi-logarithmique}
\label{fig:degree_dist}
\end{figure}

La décroissance linéaire observée en échelle semi-logarithmique est caractéristique des lois de puissance, signature des réseaux \textit{Scale-Free}. Cette propriété indique l'existence de \textit{hubs}, c'est-à-dire d'individus exceptionnellement connectés qui jouent un rôle structurant dans le réseau. Ces étudiants populaires constituent des points de passage obligés pour la circulation de l'information sociale.
...
\begin{table}[H]
\centering
\caption{Précision de Label Propagation sur 8 réseaux (fraction masquée = 10\%)}
\label{tab:label_prop}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccccccc}
\toprule
\textbf{Réseau} & \textbf{N\oe uds} & \textbf{Dortoir} & \textbf{Classes} & \textbf{Filière} & \textbf{Classes} & \textbf{Genre} & \textbf{Classes} \\
\midrule
Caltech36 & 762 & \textbf{94.9\%} & 8 & 27.9\% & 30 & 68.1\% & 2 \\
Rice31 & 4\,083 & \textbf{92.1\%} & 9 & 31.8\% & 46 & 61.5\% & 2 \\
American75 & 6\,370 & 75.5\% & 25 & 28.8\% & 75 & 58.4\% & 2 \\
MIT8 & 6\,402 & 70.6\% & 63 & 34.6\% & 43 & 66.3\% & 2 \\
Duke14 & 9\,885 & 53.5\% & 135 & 29.6\% & 66 & 70.5\% & 2 \\
UNC28 & 18\,158 & 52.6\% & 93 & 26.5\% & 73 & 63.1\% & 2 \\
Texas84 & 36\,364 & 56.9\% & 92 & 30.6\% & 107 & 61.2\% & 2 \\
Simmons81 & 1\,510 & 40.0\% & 10 & 25.9\% & 53 & \textbf{99.3\%} & 2 \\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{table}
...
L'analyse de la filière d'études (\textit{Major}) révèle un signal intermédiaire. Avec une précision moyenne oscillant entre 25\% et 35\%, la propagation de labels fait nettement mieux que le hasard (qui serait inférieur à 2\% vu le nombre élevé de filières, souvent supérieur à 50). Cependant, ce score reste bien en deçà des performances obtenues pour le dortoir. Cela indique que si les étudiants tendent à avoir des amis dans leur filière, ce n'est pas le facteur déterminant de leurs interactions sociales.

Sur les grandes universités comme Duke14 (135 dortoirs) ou UNC28 (93 dortoirs), la précision du dortoir reste honorable (53-55\%) malgré le nombre élevé de classes. Ramené au hasard (qui donnerait moins de 1\% sur Duke), ce score démontre que la structure du graphe encode efficacement l'information résidentielle.
